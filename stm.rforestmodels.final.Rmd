...
t10.12 <- srl.topics.12 %>%
  select(Topic10, starts_with("srl")) %>%
  na.omit()
...
t11.12 <- srl.topics.12 %>%
  select(Topic11, starts_with("srl")) %>%
  na.omit()
...
t12.12 <- srl.topics.12 %>%
  select(Topic12, starts_with("srl")) %>%
  na.omit()
